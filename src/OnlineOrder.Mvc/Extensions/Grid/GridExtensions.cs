...
namespace OnlineOrder.Mvc.Grid
{
	...
	public static class GridExtensions
	{
		...
		/// <returns></returns>
        public static IGrid<T> Grid<T>(this HtmlHelper helper, IPagination<T> dataSource) where T : class
		{
			return new Grid<T>(dataSource, helper.ViewContext);
		}

        /// <summary>
        /// Creates a grid using the IPagination<dynamic> datasource.
        /// </summary>
        /// <typeparam name="T"></typeparam>
        /// <param name="helper"></param>
        /// <param name="dataSource"></param>
        /// <returns></returns>
        public static IGrid<T> Grid<T>(this HtmlHelper helper, IPagination<dynamic> dataSource) where T : class
        {
            return new Grid<T>(dataSource, helper.ViewContext);
        }

        /// <summary>
        /// Creates a grid using the ICollection<T> datasource.
        /// </summary>
        /// <typeparam name="T"></typeparam>
        /// <param name="helper"></param>
        /// <param name="dataSource"></param>
        /// <returns></returns>
        public static IGrid<T> Grid<T>(this HtmlHelper helper, ICollection<T> dataSource) where T : class
        {
		...
		{
            var dataSource = helper.ViewContext.ViewData.Eval(viewDataKey) as IPagination<T>;
